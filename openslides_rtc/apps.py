...
class RtcPluginAppConfig(AppConfig):
    name = 'openslides_rtc'
    ...
    js_files = [
        'static/js/openslides_rtc/base.js',
        'static/js/openslides_rtc/site.js',
        'static/js/openslides_rtc/openslides-peer.js',
        'static/js/openslides_rtc/templatehooks.js',
        'static/js/openslides_rtc/templates.js'
    ]
    ...
    def ready(self):
        ...
        post_permission_creation.connect(
            add_permissions_to_builtin_groups,
            dispatch_uid='openslides_rtc_add_permissions_to_builtin_groups'
        )
