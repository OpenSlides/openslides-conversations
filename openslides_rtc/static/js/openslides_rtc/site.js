...
angular.module('OpenSlidesApp.openslides_rtc.site', [
    'OpenSlidesApp.openslides_rtc',
    'OpenSlidesApp.openslides_rtc.templates',
    'OpenSlidesApp.openslides_rtc.templatehooks',
])
...
.config([
    ...
    function (mainMenuProvider, gettext) {
        mainMenuProvider.register({
            'ui_sref': 'openslides_rtc_moderated',
            'img_class': 'comments',
            'title': gettext('Conversations'),
            'weight': 5000,
            'perm': 'openslides_rtc.can_use_conversations',
        });
    }
])
...
.config([
    ...
    function ($stateProvider) {
        $stateProvider
            .state('openslides_rtc_moderated', {
                url: '/openslides_rtc',
                templateUrl: 'static/templates/openslides_rtc/moderated-discussion.html',
            })
            .state('openslides_rtc_private', {
                url: '/openslides_rtc/private',
                templateUrl: 'static/templates/openslides_rtc/private-chat.html',
            })
            .state('openslides_rtc_group', {
                url: '/openslides_rtc/group',
                templateUrl: 'static/templates/openslides_rtc/group-conversation.html',
            });
    }
])

//the user bar hook
.controller('OpenSlidesRTCUserBarHookCtrl', [
    '$scope',
    'MediaAccess',
...
.controller('OpenSlidesRTCModeratedDiscussionCtrl', [
    '$scope',
    '$timeout',
    '$http',
    'MediaAccess',
...
.controller('OpenSlidesRTCGroupConversationsCtrl', [
    '$scope',
    '$timeout',
    'MediaAccess',
    'PeerConnection',
...
.controller('OpenSlidesRTCPrivateChatCtrl', [
    '$scope',
    '$timeout',
    'MediaAccess',
    'PeerConnection',
